...
`,e.jsxs(s.li,{children:[e.jsx(s.code,{children:"document.documentElement.style.fontSize"})," — ",e.jsx(s.code,{children:"16px"})," / ",e.jsx(s.code,{children:"18px"})," / ",e.jsx(s.code,{children:"20px"}),", matching production accessibility sizing."]}),`
`]}),`
...
`,e.jsxs(s.p,{children:["Storybook does not execute API calls, routing, or Capacitor unless a story mocks them. Use ",e.jsx(s.strong,{children:"Vitest"})," and ",e.jsx(s.strong,{children:"Playwright"})," for end-to-end behaviour; use Storybook for visual states and a11y review with the ",e.jsx(s.strong,{children:"Accessibility"})," addon."]})]})}function c(t={}){const{wrapper:s}={...o(),...t.components};return s?e.jsx(s,{...t,children:e.jsx(n,{...t})}):n(t)}export{c as default};
